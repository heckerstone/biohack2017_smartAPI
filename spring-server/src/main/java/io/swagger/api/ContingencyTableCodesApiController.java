...
public class ContingencyTableCodesApiController implements ContingencyTableCodesApi {
    ...
    public ResponseEntity<Void> contingencyTableCodes( @NotNull@ApiParam(value = "RxNorm drug code for search", required = true) @RequestParam(value = "drugCode", required = true) String drugCode,
