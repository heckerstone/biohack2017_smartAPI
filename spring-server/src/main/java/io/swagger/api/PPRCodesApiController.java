...
@Controller
public class PPRCodesApiController implements PPRCodesApi {



    public ResponseEntity<Void> pprCodes( @NotNull@ApiParam(value = "RxNorm drug code for search", required = true) @RequestParam(value = "drugCode", required = true) String drugCode,
