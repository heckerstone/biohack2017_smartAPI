...
/**
 * API tests for ProportionalReportingRatioApi
 */
@Ignore
public class ProportionalReportingRatioApiTest {

    private final ProportionalReportingRatioApi api = new ProportionalReportingRatioApi();
     ...
     */
    @Test
    public void pprCodesTest() throws ApiException {
        String drugCode = null;
        String outcomeCode = null;
        api.pprCodes(drugCode, outcomeCode);
     ...
     */
    @Test
    public void pprNamesTest() throws ApiException {
        String drugName = null;
        String outcomeName = null;
        api.pprNames(drugName, outcomeName);
